...
// CDSP
	...
	MSG_JPEG_DECODE_DATA = 0x01900000,
	AVIPACKER_MSG_VIDEO_WRITE_DONE = 0x01A00000
...
typedef enum
{
	...
	MSG_VIDEO_ENCODE_FIFO_3ND_DATE      = 0x00700000,
	MSG_VIDEO_ENCODE_FIFO_4ND_DATE      = 0x00800000,
	MSG_VIDEO_ENCODE_FIFO_5ND_DATE      = 0x00900000,
	MSG_VIDEO_ENCODE_FIFO_LAST_DATE     = 0x00A00000,
	MSG_SCALER_INPUT_EMPTY				= 0x00B00000
...
typedef enum
{
	...
	MSG_PERIPHERAL_TASK_SHUTOFF_SET,
	MSG_PERIPHERAL_TASK_ZD,
	MSG_PERIPHERAL_TASK_LOWBATT_SHUT,
	MSG_LDWS_DO
...
typedef enum
{
	...
	MSG_APQ_QUICK_RECORD,
    MSG_APQ_AUDO_ACTIVE,
    MSG_APQ_POWER_ON_AUDO_ACTIVE,
    MSG_APQ_SENSOR_FILP,
    MSG_APQ_MD_SET,
	EVENT_APQ_ERR_MSG
