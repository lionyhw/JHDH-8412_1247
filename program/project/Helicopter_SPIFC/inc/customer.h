...
// Motion detection
#define MD_STOP_TIME			180//10		// when MD_STOP_TIME seconds detect no motion then stop video record
...
#define LED1					IO_A6// IO_B2
#define LED2					IO_A7// IO_B3


#define I2C_SCL 				IO_E5	// G_Sensor I2C clock pin
#define I2C_SDA 				IO_E4	// G_Sensor I2C data pin
...
#define PIR_MODE				IO_E7
#define IR_CTRL                 IO_D13
#define SWITCH_KEY              IO_D10

#define POWER_EN				IO_C12
#define CHARGE_PIN				IO_F15

#define CDSP_IQ 				GPCV1248_JVIN_V1_0
#define PRODUCT_NUM 			8412
#define PRODUCT_DATA			20180515
