			        ...
			        for (i=0; i<sizeof(GC1004_MIPI_720P)/2; i++) 
			         {
				       reg_tmp = GC1004_MIPI_720P[i][0];
					       ...
					       if(reg_tmp == 0x17)
					   	{
					   	 if(sensor_filp)
					   	 	{
					   	 	 GC1004_MIPI_720P[i][1]  =0x17;
							  DBG_PRINT("-INIT_SEN1\r\n");
					   	 	}
						 else
						 	{
						 	 GC1004_MIPI_720P[i][1]  =0x14;
							  DBG_PRINT("-INIT_SEN0\r\n");
						 	}
					   	}
						 else if(reg_tmp ==0x92)
						 	{
						 	 if(sensor_filp)
					   	 	{
					   	 	 GC1004_MIPI_720P[i][1]  =0x10;
					   	 	}
						 else
						 	{
						 	 GC1004_MIPI_720P[i][1]  =0x01;
						 	}
						 	}
						 #endif
				         ...
				         for (i=0; i<sizeof(GC1014_MIPI_720P)/2; i++) 
			         {
				       reg_tmp = GC1014_MIPI_720P[i][0];
					       ...
					       if(reg_tmp == 0x17)
					   	{
					   	 if(sensor_filp)
					   	 	{
					   	 	 GC1014_MIPI_720P[i][1]  =0x17;
							  DBG_PRINT("-INIT_SEN1\r\n");
					   	 	}
						 else
						 	{
						 	 GC1014_MIPI_720P[i][1]  =0x14;
							  DBG_PRINT("-INIT_SEN0\r\n");
						 	}
					   	}
						 else if(reg_tmp ==0x92)
						 	{
						 	 if(sensor_filp)
					   	 	{
					   	 	 GC1014_MIPI_720P[i][1]  =0x10;
					   	 	}
						 else
						 	{
						 	 GC1014_MIPI_720P[i][1]  =0x01;
						 	}
						 	}
						 #endif
