...
//DBG_PRINT("wwj: R_IOH_BUFFER == 0x%x\r\n", R_IOH_BUFFER);
  ...
  //#endif
	...
	R_SYSTEM_CLK_EN1 &= (~0x2022);
	 ...
	 //壽敕HDMI
    R_SYSTEM_CLK_EN0 |= 0x08;
    
    R_SYSTEM_CKGEN_CTRL |= 0x04;  // 嶱 HDMI clk  (PLL148M_EN) 
	R_SYSTEM_PLLEN |= 0x80;  // 嶱 HDMI clk ( HDMI_CKEN) 
	R_HDMITXPHYCONFIG1 |= 0x01;  // PwrDown HDMI 
